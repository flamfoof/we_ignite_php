        ...
        <div class="card-header">
            <div class="d-flex flex-column flex-sm-row flex-wrap mb-headings align-items-start align-items-sm-center">
                <div class="flex mb-2 mb-sm-0">
                    <h1 class="h2">Lista de Provincias</span></h1>
                </div>
                <a href="<?= base_url("admin/provincia/nueva") ?>" class="btn btn-success ml-auto">Nueva Provincia</a>
            </div>
        </div>
        <div class="card-body">
            <!-- Wrapper -->
                        ...
                        <?php foreach ($fichas as $ficha): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url("admin/provincia/{$ficha->_id()}/editar") ?>">
                                        <i data-v-134867f8="" class="material-icons icon-40pt">edit</i>
                                    </a>
                                    <a href="<?= base_url("admin/provincia/{$ficha->_id()}/borrar") ?>" class="check-link">
...
<?php $ficha = (count($fichas) > 0) ? $fichas[0] : new Provincia() ?>
<?= view("admin/provincias/partes/modal", ["ficha" => $ficha]) ?>
<?= view("admin/provincias/partes/script", ["ficha" => $ficha]) ?>
