        ...
        <div class="card-header">
            <div class="d-flex flex-column flex-sm-row flex-wrap mb-headings align-items-start align-items-sm-center">
                <div class="flex mb-2 mb-sm-0">
                    <h1 class="h2">Lista de Ciudades</span></h1>
                </div>
                <a href="<?= base_url("admin/ciudad/nueva") ?>" class="btn btn-success ml-auto">Nueva Ciudad</a>
            </div>
        </div>
        <div class="card-body">
            <!-- Wrapper -->
                        ...
                        <?php foreach ($fichas as $ficha): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url("admin/ciudad/{$ficha->_id()}/editar") ?>">
                                        <i data-v-134867f8="" class="material-icons icon-40pt">edit</i>
                                    </a>
                                    <a href="<?= base_url("admin/ciudad/{$ficha->_id()}/borrar") ?>" class="check-link">
...
<?php $ficha = (count($fichas) > 0) ? $fichas[0] : new Ciudad() ?>
<?= view("admin/ciudades/partes/modal", ["ficha" => $ficha]) ?>
<?= view("admin/ciudades/partes/script", ["ficha" => $ficha]) ?>
