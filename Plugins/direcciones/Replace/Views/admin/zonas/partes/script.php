<script type="text/javascript">
    $(".open-modal").click(function(){
        ...
        $('#modalEditTitle').html("Editar Provincias seleccionadas");
    ...
    $(".open-modal-all").click(function(){
        ...
        $('#modalEdit').appendTo("body").modal('show');
        $('#modalEditTitle').html("Editar todos las Provincias");
    ...
    $(document).on("click", "#btn-aceptar", function(){
        ...
        if ($(this).attr("data-aceptar") == "todos") {
            ...
            var url = "<?= base_url("admin/provincia/editar/todos") ?>";
            console.log(url);
            $.post(url, {
                metodo:metodo,
                estado:estado,
            ...
            var url = "<?= base_url("admin/provincia/editar/seleccionados") ?>";
            console.log(url);
            $.post(url, {
                metodo:metodo,
                estado:estado,
