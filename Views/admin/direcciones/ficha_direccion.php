        ...
        <div class="col-lg container-fluid page__container">
                            ...
                            <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                <div class="form-row mb-1">
                                    ...
                                    <div class="btn btn-info col-md-2 openEditionModal"
                                        data-get="<?= base_url("admin/direccion/{$curusuario->_id()}/pais/0/modal") ?>"
                                        data-action="<?= base_url("admin/direccion/{$curusuario->_id()}/pais/0/modal") ?>"
                                ...
                                <div class="form-row mb-1">
                                    <?= view("admin/direcciones/partes/provincias", ["provincias" => $ficha->getPais()->getProvincias(), "direccion" => $ficha]) ?>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url("admin/usuario/{$curusuario->_id()}/editar") ?>" class="btn btn-danger">Regresar</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function loadProvincias(pais){
        var url = "<?= base_url("provincias/options") ?>/"+pais+"/0";
        console.log(url);
