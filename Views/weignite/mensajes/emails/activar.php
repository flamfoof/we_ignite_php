                                                ...
                                                <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                    <strong>
                                                        <span style="font-size: 18px; line-height: 21px;">
                                                            Hello <?= mb_strtoupper($usuario->_get("nombre")." ".$usuario->_get("apellidos")) ?>,
                                                        </span>
                                                    </strong>
                                                </p>
                                            </div>
                                            ...
                                            <div style="font-size: 12px; line-height: 14px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0; text-transform: uppercase;">
                                                    <span style="font-size: 14px; line-height: 16px;">
                                                        Thank you for register in <?= $config->_get("nombretienda") ?>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div style="border-top:1px solid #D9D9D9; border-left:1px solid #D9D9D9; border-bottom:1px solid #D9D9D9; border-right:1px solid #D9D9D9; padding-top:10px; padding-bottom:15px; padding-right: 10px; padding-left: 10px;">
                                            ...
                                            <div style="font-size: 12px; line-height: 14px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                <p style="font-size: 14px; line-height: 16px; margin: 0;">
                                                    <span style="font-size: 14px; line-height: 16px; text-transform: uppercase;">
                                                        <strong>
                                                            Here are you account details on <?= $config->_get("nombretienda") ?>
                                                        </strong>
                                                    </span>
                                                </p>
                                            </div>
                                        ...
                                        <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <div style="font-size: 12px; line-height: 14px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                ...
                                                <p style="font-size: 14px; line-height: 16px; margin: 0;">
                                                    <strong>Email:</strong> <?= $usuario->_get("email") ?>
                                                </p>
                                                <p style="font-size: 14px; line-height: 16px; margin: 0;">
                                                    <strong>Get a new password:</strong>
                                                    <a href="<?= site_url("login/activar/cuenta/{$usuario->_get("log")}") ?>">
                                                        Set my new password
                                                    </a>
                                                </p>
                                            </div>
                            ...
                            <div class="col num12" style="min-width: 320px; max-width: 500px; display: table-cell; vertical-align: top;;">
                                <div style="width:100% !important;">
                                    ...
                                    <div style="border-top:1px solid #D9D9D9; border-left:1px solid #D9D9D9; border-bottom:1px solid #D9D9D9; border-right:1px solid #D9D9D9; padding-top:10px; padding-bottom:15px; padding-right: 10px; padding-left: 10px;">
                                        ...
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
                                        <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <ol style="color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 120%;">
                                                <li style="font-size: 12px; line-height: 14px;">
                                                    Keep your access data in a safe place.
                                                </li>
                                                <li style="font-size: 12px; line-height: 14px;">
                                                    Don't share your account information with anybody
                                                </li>
                                                <li style="font-size: 12px; line-height: 14px;">
                                                    Change your password regulary
                                                </li>
                                                <li style="font-size: 12px; line-height: 14px;">
                                                    If you belive some has  illegal acces to your account. Contact with us or renew your password.
                                                </li>
                                            </ol>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="width:100% !important;">
                                    ...
                                    <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                        ...
                                        <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <div style="font-size: 12px; line-height: 14px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                <p style="font-size: 14px; line-height: 16px; margin: 0;">
                                                    Now you can download our app in
                                                    <a href="<?= site_url() ?>">
